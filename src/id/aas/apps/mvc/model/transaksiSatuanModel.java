 ...
 * @author Aas Suhendar
 */
public class transaksiSatuanModel {

    private ResultSet rs;

    public transaksiSatuanModel() {
        ConnectionDB.InstanceDB.openConnection();
    }

    public ResultSet getAllDataTransaksiSatuan() throws SQLException {
        try {
            String query = "SELECT transaksi.kd_transaksi, transaksi.kd_laundry, pelanggan.nama, laundry.jenis_layanan, laundry.jenis_pawangi, transaksi.tgl_terima, transaksi.tgl_selesai, "
                    ...
                    + "WHERE transaksi.id_pelanggan=pelanggan.id_pelanggan AND transaksi.kd_laundry=laundry.kd_laundry AND laundry.jenis_layanan='Laundry Satuan'";
    ...
    public boolean insertTransaksiSatuan(Laundry l, Transaksi t) throws SQLException {
        ...
        try {
            String queryLaundry = "INSERT INTO laundry (kd_laundry,jenis_layanan, jenis_pawangi, berat, jumlah_pakaian, jenis_pakaian, harga_satuan, total, keterangan) "
                    + "VALUES (" + l.getKd_laundry() + ",'Laundry Satuan','" + l.getJenisPewangi() + "',0," + l.getJumPakaian() + ",'" + l.getJenisPakaian() + "'," + l.getHargaSatuan() + "," + l.getTotalTagihan() + ",'Belum Diambil')";
    ...
    public ResultSet ambilDataLaundrySatuan() throws SQLException {
        try {
